...
# model = AutoModelForCausalLM.from_pretrained('/home/dilab/yohan/llm-factory/train_llm/train_model/polyglot-ko-12.8b-koqaulity/checkpoint-18')
# model.push_to_hub("DILAB-HYU/koquality-polyglot-12.8b")
# tokenizer = AutoTokenizer.from_pretrained('/home/dilab/yohan/llm-factory/train_llm/train_model/polyglot-ko-12.8b-koqaulity/checkpoint-18')
# tokenizer.push_to_hub("DILAB-HYU/koquality-polyglot-12.8b")


tokenizer = AutoTokenizer.from_pretrained('/home/dilab/yohan/llm-factory/train_llm/train_model/polyglot-ko-12.8b-inst/checkpoint-96')
tokenizer.push_to_hub("nayohan/polyglot-ko-12.8b-Inst-All")
model = AutoModelForCausalLM.from_pretrained('/home/dilab/yohan/llm-factory/train_llm/train_model/polyglot-ko-12.8b-inst/checkpoint-96')
model.push_to_hub("nayohan/polyglot-ko-12.8b-Inst-All")