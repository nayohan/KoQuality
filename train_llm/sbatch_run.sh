...
# # koquality 0.01
# torchrun --nproc_per_node=6 --master_port=34321 run_clm.py \
# --model_name_or_path='EleutherAI/polyglot-ko-12.8b' \
# --train_file='/home/dilab/yohan/llm-factory/train_llm/train_dataset/koquality_raw.json' \
# --num_train_epochs=5 \
# --block_size=1024 \
...
torchrun --nproc_per_node=6 --master_port=34321 run_clm.py \
--model_name_or_path='EleutherAI/polyglot-ko-12.8b' \
--train_file='/home/dilab/yohan/llm-factory/train_llm/train_dataset/result_len5_k100_mppl_n0.01.json' \
--num_train_epochs=2 \
--block_size=1024 \
--per_device_train_batch_size=4 \
...
--torch_dtype=float16 \
--fp16 \
--output_dir='train_model/polyglot-ko-12.8b-koqaulity' \
--deepspeed=ds_zero3-nooffload.json \
--do_train \
--do_eval \
--evaluation_strategy='steps' \
...
--max_eval_samples=1000 \
--use_auth_token=True \
--run_name='polyglot-ko-12.8b-koqaulity'
